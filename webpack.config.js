...
module.exports = (env, argv) => {
    ...
    let config = {
        ...
        output: {
            ...
            filename: 'renewex_poc_app.bundle.js',
            chunkFilename: '[name].renewex.[chunkhash:6].js'
        },
        resolve: {
        ...
        plugins: [
            ...
            new CleanWebpackPlugin({
                cleanOnceBeforeBuildPatterns: [`${path.resolve(__dirname, 'src/main/resources/javascript/webapp')}/**/*`],
                verbose: false
            }),
